...
class operationParser ( Parser ):
    ...
    class StartContext(ParserRuleContext):
        ...
        def prog(self):
            return self.getTypedRuleContext(operationParser.ProgContext,0)


        def EOF(self):
            return self.getToken(operationParser.EOF, 0)

        def getRuleIndex(self):
            return operationParser.RULE_start
    ...
    def start(self):
        ...
        localctx = operationParser.StartContext(self, self._ctx, self.state)
        ...
        try:
            ...
            self.prog(0)
            self.state = 15
            self.match(operationParser.EOF)
    ...
    class ProgContext(ParserRuleContext):
        ...
        def assign(self):
            return self.getTypedRuleContext(operationParser.AssignContext,0)
        ...
        def getRuleIndex(self):
            return operationParser.RULE_prog
    ...
    def prog(self, _p:int=0):
        ...
        localctx = operationParser.ProgContext(self, self._ctx, _parentState)
        _prevctx = localctx
        _startState = 2
        ...
        try:
            ...
            while _alt!=2 and _alt!=ATN.INVALID_ALT_NUMBER:
                if _alt==1:
                    ...
                    _prevctx = localctx
                    localctx = operationParser.ProgContext(self, _parentctx, _parentState)
    ...
    class AssignContext(ParserRuleContext):
        ...
        def Id(self):
            return self.getToken(operationParser.Id, 0)

        def expr(self):
            return self.getTypedRuleContext(operationParser.ExprContext,0)


        def NEWLINE(self):
            return self.getToken(operationParser.NEWLINE, 0)

        def EOF(self):
            return self.getToken(operationParser.EOF, 0)

        def getRuleIndex(self):
            return operationParser.RULE_assign
    ...
    def assign(self):
        ...
        localctx = operationParser.AssignContext(self, self._ctx, self.state)
        self.enterRule(localctx, 4, self.RULE_assign)
        self._la = 0 # Token type
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 27
            self.match(operationParser.Id)
            self.state = 28
            self.match(operationParser.T__0)
            self.state = 29
            self.expr(0)
            self.state = 30
    ...
    class ExprContext(ParserRuleContext):
        ...
        def term(self):
            return self.getTypedRuleContext(operationParser.TermContext,0)
        ...
        def getRuleIndex(self):
            return operationParser.RULE_expr
    ...
    def expr(self, _p:int=0):
        _parentctx = self._ctx
        _parentState = self.state
        localctx = operationParser.ExprContext(self, self._ctx, _parentState)
        _prevctx = localctx
        _startState = 6
        ...
        try:
            ...
            while _alt!=2 and _alt!=ATN.INVALID_ALT_NUMBER:
                if _alt==1:
                    ...
                    if la_ == 1:
                        localctx = operationParser.ExprContext(self, _parentctx, _parentState)
                        ...
                        self.state = 36
                        self.match(operationParser.T__1)
                        self.state = 37
                        self.term(0)
                        pass
                        ...
                        if not self.precpred(self._ctx, 2):
                            ...
                            raise FailedPredicateException(self, "self.precpred(self._ctx, 2)")
                        self.state = 39
                        self.match(operationParser.T__2)
                        self.state = 40
                        self.term(0)
                        pass
    ...
    class TermContext(ParserRuleContext):
        ...
        def factor(self):
            return self.getTypedRuleContext(operationParser.FactorContext,0)
        ...
        def getRuleIndex(self):
            return operationParser.RULE_term
    ...
    def term(self, _p:int=0):
        _parentctx = self._ctx
        _parentState = self.state
        localctx = operationParser.TermContext(self, self._ctx, _parentState)
        _prevctx = localctx
        _startState = 8
        ...
        try:
            ...
            while _alt!=2 and _alt!=ATN.INVALID_ALT_NUMBER:
                if _alt==1:
                    ...
                    if la_ == 1:
                        localctx = operationParser.TermContext(self, _parentctx, _parentState)
                        ...
                        if not self.precpred(self._ctx, 3):
                            ...
                            raise FailedPredicateException(self, "self.precpred(self._ctx, 3)")
                        self.state = 50
                        self.match(operationParser.T__3)
                        self.state = 51
                        self.factor()
                        pass
                        ...
                        if not self.precpred(self._ctx, 2):
                            ...
                            raise FailedPredicateException(self, "self.precpred(self._ctx, 2)")
                        self.state = 53
                        self.match(operationParser.T__4)
                        self.state = 54
                        self.factor()
                        pass
    ...
    class FactorContext(ParserRuleContext):
        ...
        def number(self):
            return self.getTypedRuleContext(operationParser.NumberContext,0)


        def String(self):
            return self.getToken(operationParser.String, 0)

        def getRuleIndex(self):
            return operationParser.RULE_factor
    ...
    def factor(self):
        ...
        localctx = operationParser.FactorContext(self, self._ctx, self.state)
        ...
        try:
            ...
            if token in [6]:
                self.enterOuterAlt(localctx, 1)
                self.state = 60
                self.match(operationParser.T__5)
                self.state = 61
                self.expr(0)
                self.state = 62
                self.match(operationParser.T__6)
                pass
            elif token in [8]:
                ...
                self.state = 66
                self.match(operationParser.String)
                pass
            else:
    ...
    class NumberContext(ParserRuleContext):
        ...
        def INT(self):
            return self.getToken(operationParser.INT, 0)

        def FLOAT(self):
            return self.getToken(operationParser.FLOAT, 0)

        def getRuleIndex(self):
            return operationParser.RULE_number
    ...
    def number(self):
        ...
        localctx = operationParser.NumberContext(self, self._ctx, self.state)
